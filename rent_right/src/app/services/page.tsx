...
export default function ServicesPage() {
  ...
  return (
      <div className="p-8 bg-blue-100 min-h-screen">
          ...
          {services.map((service, index) => (
            <Card key={index} className="p-6 shadow-md rounded-lg bg-white">
              <CardContent className="flex flex-col items-center text-center">
                <div className="text-5xl text-blue-700 mb-4">{service.icon}</div>
        ...
        <p className="text-center p-10">At RentRight, we are committed to making your rental experience as seamleass and stress-free as possible.<br/>
            We connect you with skilled professionals- whether you nees a plumber, electrician, carpenter or pest control expert.<br/>
            Say goodbye to the frustration of waiting weeks for unresolved issues.<br/>
            With RentRight, help is just a request away!<br/>
            Your comfort is our priority. Let us take casre of the details while you enjoy a hassle-free living experience.
        </p>
        <p className="text-center text-blue-700">Reliable home maintenance solutions at your service.</p>
        <div className="text-center mt-8">
          <Button className="bg-blue-600 text-white px-6 py-3" onClick={()=>{
